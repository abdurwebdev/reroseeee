            ...
            {earningsData && (
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                  ...
                  <div className="bg-gradient-to-r from-red-900 to-red-700 rounded-lg p-6 shadow-lg">
                    <h3 className="text-lg font-medium text-red-200">Platform Cut</h3>
                    <p className="text-3xl font-bold mt-2">
                      {100 - settings.subscriptionSharingRate}%
                    </p>
